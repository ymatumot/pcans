...
plot,x,dni/n0,xs=1,ys=2,xtickname=replicate(' ',8),$
     ytitle='!6N/N!I0!N',chars=chars,pos=[0.125,0.85,0.972,0.99],xrange=xrange
oplot,x,dne/n0,col=50
legend,['!6ion','electron'],line=[0,0],color=[0,50]
xyouts,0.8,0.88,'!7X!6!Igi!NT='+strcompress(string(time[i],format='(f6.2)'),/remove),/normal
plot,x,bz/b0, xs=1,ys=2,xtickname=replicate(' ',6),$
     ytitle='!6B!Iz!N/B!I0!N',chars=chars,pos=[0.125,0.705,0.972,0.845],/noerase,xrange=xrange
plot,x,ex/e0,xs=1,ys=2,xtickname=replicate(' ',6),$
     ytitle='!6E!Ix!N/E!I0!N',chars=chars,pos=[0.125,0.56,0.972,0.700],/noerase,xrange=xrange
plot_clcnt,psdi,ct=ct,pos=[0.125,0.972,0.32,0.53],/nocolbar,/keep,/noerase,$
           xtickname=replicate(' ',6),chars=chars,xax=xax_i,yax=yax_i,$
           title='!6PSD-i',ytitle='!6u!Ix!N/c'
plot_clcnt,psde,ct=ct,pos=[0.125,0.972,0.075,0.285],/nocolbar,/keep,/noerase,$
