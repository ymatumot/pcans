...
!! SETUP FOR SUBROUTINES CALLED IN MAIN PROGRAM
  integer, parameter :: itmax  = 400000 !NUMBER OF ITERATION
...
!!   vbeam : RELATIVE STREAMING VELOCITY TO VAI
!!   tbeam : TEMPERATURE RATIO (BEAM / CORE)
  integer, parameter :: n0     = 250
  real(8), parameter :: vte    = 1.0D0   
  real(8), parameter :: fpe    = 1.0D0   
  real(8), parameter :: rmass  = 25.0D0
  real(8), parameter :: sigma  = 0.04D0
  real(8), parameter :: betai  = 0.03125, betae = 0.5D0
  real(8), parameter :: nbeam  = 0.2, vbeam = 3.0, tbeam = 1.0
